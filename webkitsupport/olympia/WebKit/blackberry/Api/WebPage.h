...
#if PLATFORM(OLYMPIA)
            // Used for changing the screen's size on the browser of windows and linux
            void setScreenSize(const Platform::IntSize& screenSize, const Platform::IntSize& defaultLayoutSize, const Platform::IntRect& viewportRect);
#endif
