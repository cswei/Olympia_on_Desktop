...
void ChromeClientBlackBerry::runJavaScriptAlert(Frame*, const String& message)
{
    if (m_webPage->d->m_dumpRenderTree) {
...
bool ChromeClientBlackBerry::runJavaScriptConfirm(Frame*, const String& message)
{
    if (m_webPage->d->m_dumpRenderTree)
...
bool ChromeClientBlackBerry::runJavaScriptPrompt(Frame*, const String& message, const String& defaultValue, String& result)
{
...
void ChromeClientBlackBerry::setToolTip(const String&, TextDirection)
{
    notImplemented();
}

void ChromeClientBlackBerry::didReceiveViewportArguments(Frame* frame, const ViewportArguments& arguments)
{
...
void ChromeClientBlackBerry::requestGeolocationPermissionForFrame(Frame*, Geolocation* geolocation)
{
...
bool ChromeClientBlackBerry::setCursor(PlatformCursorHandle)
{
    notImplemented();
    return false;
}
